...
<p>ColtJS is a simple framework allowing for easy deployment of JavaScript Applications using Asynchronous Module Definition (AMD). It's only dependency is <a target="_blank" href="http://www.requirejs.org">RequireJS</a>. The central concept behind behind 
    Colt is simplicity. The framework is built to be lightweight, flexible, and highly efficient.</p>
    
<p>There are plenty Swiss-Army-Knife frameworks out there, Colt aims to give a solid, reliable foundation with a minimal footprint and set of tools which are truly needed. It is easily expandable with <a target="_blank" href="https://github.com/Fluidbyte/ColtJS/tree/master/utils">utils</a> that 
